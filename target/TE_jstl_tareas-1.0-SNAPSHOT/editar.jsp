                    ...
                    <tr>
                        ...
                        <td>
                            <select name="prioridad">
                                <option value="Alta" <c:if test="${miTarea.prioridad == 'Alta'}" var="res" scope="request">
                                        selected
                                </c:if>>
                                    Alta
                                </option>
                                <option value="Media"<c:if test="${miTarea.prioridad == 'Media'}" var="res" scope="request">
                                        selected
                                </c:if>>
                                    Media
                                </option>
                                <option value="Baja"<c:if test="${miTarea.prioridad == 'Baja'}" var="res" scope="request">
                                        selected
                                </c:if>>
                                    Baja
                                </option>
